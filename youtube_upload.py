...
def upload(fn, title, description, category, keywords, privacy):

  argparser.add_argument("--file", help="Video file to upload", default=fn)
  ...
  argparser.add_argument("--privacyStatus", choices=VALID_PRIVACY_STATUSES, default=privacy, help="Video privacy status.")
